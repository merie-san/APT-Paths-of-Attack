...
step_seq = [(NetstatRecStep(0), 1
            ...
            (ZeroLenExploit("10.0.0.8", "client1", "pass1", mean_duration=320, pause=0), 1
             ), (PauseStep(),),
            ...
            (Nmap10T5RecStep(0),), (PauseStep(),), (NmapMQTTDiscStep("10.0.0.8", pause=0),), (PauseStep(),),
            (NmapSubDiscStep("10.0.0.8", pause=0), 1
             ), (PauseStep(),), (ZeroLenExploit("10.0.0.8", "client1", "pass1", mean_duration=120, pause=0), 1
                                   ), (PauseStep(),),
            (NetstatRecStep(0),), (PauseStep(),),
            (ZeroLenExploit("10.0.0.8", "client1", "pass1", mean_duration=120, pause=0), 1
             ), (PauseStep(),),
            ...
            (ZeroLenExploit("10.0.0.8", "client1", "pass1", mean_duration=800, pause=0), 1
             ), (PauseStep(),),
