...
step_seq = [(NetstatRecStep(5), 2), (Nmap192T5RecStep(10), 2), (PauseStep(80), 1),
            ...
            (BruteForceStep(10, action='t', is_distributed=True),),
            ...
            (ScpInstStep("10.0.0.4", ["/user_property_attack.py"], pause=12), 1),
            (ScpInstStep("10.0.0.6", ["/user_property_attack.py"], pause=12), 1),
            (ScpInstStep("10.0.0.7", ["/user_property_attack.py"], pause=12), 1),
            (ScpInstStep("10.0.0.8", ["/user_property_attack.py"], pause=12), 1),
            (ScpInstStep("10.0.0.9", ["/user_property_attack.py"], pause=12), 1),
            (ScpInstStep("10.0.0.15", ["/user_property_attack.py"], pause=12), 1),
            ...
            (PauseStep(60), 1), (Nmap10T5RecStep(3), 5), (BruteForceStep(2.5, action='t'),), (PauseStep(180), 1),
