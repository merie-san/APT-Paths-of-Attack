...
attack = APT.APTAttack(attack_seq1, "empty_conn_ddos", exp_details, "./out/experiment_details.pkl")
...
attack = APT.APTAttack(attack_seq2, "qos_mid_dos", exp_details, "./out/experiment_details.pkl")
exp_details = attack.run()
